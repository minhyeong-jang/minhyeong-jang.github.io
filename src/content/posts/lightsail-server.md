...
![lightsail Spec](/posts/2022/lightsail-server-1.png "lightsail Spec")
...
![lightsail Spec](/posts/2022/lightsail-server-2.png "lightsail Spec")

도메인을 가비아에서 구매했고, Lightsail 서버에 연동이 필요했다.

Network 탭에서 Static IP, DNS zone을 클릭하여 IP, DNS를 발급받았다.

![lightsail Spec](/posts/2022/lightsail-server-3.png "lightsail Spec")
